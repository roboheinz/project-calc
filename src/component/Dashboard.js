...
const Dashboard = () => {
  ...
  return (
    <ScrollView className="min-w-full flex-1 py-12" horizontal={false} nestedScrollEnabled={true} alwaysBounceVertical={false} contentContainerStyle={{ flexGrow: 1, justifyContent: 'center' }}>
      <Text className="bg-red-500 p-4 text-white text-center">Logo</Text>

      <TouchableOpacity onPress={() => setOpenDatar(!openDatar)} className="my-4 bg-green-400 py-4 px-6 rounded-md">
